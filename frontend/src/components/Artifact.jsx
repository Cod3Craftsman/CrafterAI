...
import { Check, Code2, CopyIcon, Eye, PanelLeftClose, PanelRightClose, PanelRightOpen, X } from "lucide-react"
          ...
          !collapsed ?
            <div className='flex flex-col h-full bg-[#0d0f14]'>
              ...
              <div className='h-14  px-4 border-b border-white/[0.06] flex items-center gap-3 shrink-0'>
                <button className='flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer shrink-0' onClick={onClose ?? (() => setCollapsed(true))}>
                  {
                    onClose ? <X size={15} /> :
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3 right-4 z-40 flex items-center gap-2
  px-3.5 py-2 rounded-xl bg-indigo-600
  shadow-lg shadow-indigo-500/20 border-none cursor-pointer
  transition-colors duration-150 hover:bg-indigo-500
